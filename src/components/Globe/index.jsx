  ...
  return (
    <div className={`my-16 sm:my-2 pt-32 pb-16 sm:pt-32 sm:pb-32 relative ${theme==="light" && 'opacity-0'}`}>
      ...
      <div className="w-full h-full flex items-center justify-center pt-16 sm:pt-0">
        <div className={`p-[60px] sm:p-[10vw] border-[#ffffff30] ${circleClass}`}>

          <div className={`p-[25px] sm:p-[5vw] border-[#ffffff00] ${circleClass}`}>
            ...
            <div className="absolute aspect-square left-[50%] bottom-[-1%] translate-y-1/2 -translate-x-1/2 z-50">
                <h1 className="text-2xl sm:text-5xl font-normalF font-bold" style={{textShadow:"1px 2px 20px #ffffff80"}}>180+</h1>
                <p className=" text-xs sm:text-xl  font-normalF w-3/5 font-light uppercase">Languages</p>
              </div>
            ...
            <div className={`p-[50px] sm:p-[10vw] border-[#ffffff00] ${circleClass}`}>
              ...
              <div className={`p-[50px] sm:p-[8vw] border-[#ffffff00] ${circleClass}`}>
              ...
              <div className="absolute aspect-square left-[2%] top-[35%] -translate-y-1/2 -translate-x-1/2  z-50">
                <h1 className="text-2xl sm:text-5xl font-normalF font-bold" style={{textShadow:"1px 2px 20px #ffffff80"}}>50+</h1>
                <p className=" text-xs sm:text-xl font-normalF w-3/5 font-light uppercase">Tokens</p>
              </div>
