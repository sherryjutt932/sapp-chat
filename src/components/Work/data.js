export const DetailData = [
  {
    heading: "Transfer - Receive Crypto While Chatting",
    detail: "With Sappchat, you can finally send text messages and share cryptocurrency at the same time. Peer to Peer payment between users has never been easier.",
