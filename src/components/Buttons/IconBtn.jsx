...
export default function IconBtn({theme="dark", icon, label1, label2}) {
  return (
    <button className={`inline-flex text-base leading-none items-center gap-2 bg-transparent outline-none border rounded-full px-4 py-2 sm:px-6 sm:py-2 cursor-pointer ${!(theme === "dark") ? ' text-black border-black' : ' text-white border-white'}`}>
